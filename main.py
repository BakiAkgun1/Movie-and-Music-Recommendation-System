...
from musicmodal import musicmodal1

st.sidebar.title("Movie Project")
selection = st.sidebar.radio("", ( "Film Öneri Sistemi", "IMDB TOP 250", "Analiz", "Müzik Öneri Sistemi"))
...
elif selection == "Müzik Öneri Sistemi":
    musicmodal1()